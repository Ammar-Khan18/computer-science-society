...
const CodexTitle: React.FC = () => (
  <section className="flex flex-col h-140 md:min-h-screen items-center py-10 px-4 md:px-12">
    ...
    <h1 className="font-title text-5xl md:text-7xl colour-text mt-12 mb-10 md:mb-14 text-center">What is <br /> <span className="text-7xl md:text-9xl">CodeX?</span></h1>
