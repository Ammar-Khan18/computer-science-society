...
const CodexTitle: React.FC = () => (
  <section className="flex flex-col h-140 md:min-h-screen items-center py-10 px-4 md:px-12">
    ...
    <p className="font-text text-sm md:text-md colour-text text-justify md:text-center tracking-tight mx-4 md:mx-0 max-w-2xl">Codex is the flagship initiative of the IBA Computer Science Society, designed to foster learning, collaboration, and innovation among students passionate about coding and technology.</p>
